...
// Khóa API Public (anon / publishable key dành cho Web Client)
let SUPABASE_KEY = window.SUPABASE_ANON_KEY || localStorage.getItem('nb_supabase_anon_key') || "";

// Cung cấp hàm lưu anon key
